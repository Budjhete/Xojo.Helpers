#tag DesktopWindow
Begin DesktopWindow wNextcloudSelectFolder
   Backdrop        =   0
   ...
   Visible         =   True
   Width           =   422
   Begin DesktopListBox lbFolders
      ...
      _ScrollWidth    =   -1
   End
   Begin DesktopButton bSelect
      AllowAutoDeactivate=   True
      Bold            =   False
      Cancel          =   False
      Caption         =   "kSelectionner"
      Default         =   True
      Enabled         =   True
      FontName        =   "System"
      FontSize        =   0.0
...
#tag WindowCode
	...
	#tag Method, Flags = &h0
		Sub Constructor(pNCclass as NextCloudModule.NextCloudClass)
