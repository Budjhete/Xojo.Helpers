...
Protected Module NumberExtra
	...
	#tag Method, Flags = &h0, CompatibilityFlags = API2Only and ( (TargetIOS and (Target64Bit)) or  (TargetAndroid and (Target64Bit)) )
	...
	#tag Method, Flags = &h0
		Function SQLValue(Extends pCurrency As Currency) As String
		  Var rawValue As Double = pCurrency
		  Var formatted As String = Str(rawValue, "-#.00") ' Force dot as decimal separator
